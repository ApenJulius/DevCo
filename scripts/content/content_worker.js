 ...
 * @returns
 */
const toggleDevMode = (devMode) => {
    if (devMode) {
        console.log(
            "%c[DevMode]%c DevMode is enabled",
            "color: red; background-color: blue; padding: 4px;",
            "background-color: blue; padding: 4px;"
        );
        return;
    } else {
        console.log(
            "%c[DevMode]%c DevMode is disabled",
            "color: red; background-color: blue; padding: 4px;",
            "background-color: blue; padding: 4px;"
        );
        return;
