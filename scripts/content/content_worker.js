...
const listenForKeybinds = (key) => {
    document.addEventListener("keydown", (e) => {
        //example key = "ctrl+alt+e"
        ...
        //check if the key includes the modifier keys
        if (
            (e.ctrlKey || e.metaKey) &&
            e.shiftKey &&
            e.altKey &&
            e.key.toLowerCase() === fixedkey.toLowerCase()
        ) {
